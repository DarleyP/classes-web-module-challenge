...
class Car {
  ...
  drive(distance){
    const drivableM = this.tank * this.milesPerGallon;
    if(distance <= drivableM){
      this.odometer = this.odometer + distance;
      this.tank = this.tank - (distance / this.milesPerGallon)
    }else{this.odometer = this.odometer + drivableM;
    this.tank = 0;
...
constructor({name, age, location, specialty, favLanguage, catchPhrase}){
  ...
  this.specialty = specialty, this.favLanguage = favLanguage, this.catchPhrase = catchPhrase
}
demo(subject){
...
class Student extends Lambdasian {
   constructor({name, age, location, previousBackground, className, favSubjects}) {
    ...
    this.previousBackground = previousBackground, this.className = className, this.favSubjects = favSubjects
   }
   listSubjects() {
...
class ProjectManager extends Instructor{
   constructor({name, age, location, specialty, favLanguage, catchPhrase, gradClassName, favInstructor}){
    ...
    this.gradClassName = gradClassName, this.favInstructor = favInstructor; 
   } 
   standUp(channel){
